...
TEST_F(PrintfTest, decimal_positive) {
    ...
    do_test("1 %d %d %d %d %d %d %d\n", 0, 512, 12345, -909, 45634234, -16, 898982);

    test_info.my_printf.calculate_characteristics(test_info.test_file_buffer);
    test_info.c_printf.calculate_characteristics (test_info.test_file_buffer);
